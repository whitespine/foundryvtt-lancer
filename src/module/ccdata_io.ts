...
import {
  IContentPackData,
  ContentPack,
} from "machine-mind/dist/classes/ContentPack";
...
export class Converter {
  ...
  LancerCoreBonusData_to_ICoreBonusData(
    t: LancerCoreBonusData
  ): ICoreBonusData {
    return {
      id: t.id,
      brew: this.brew,
  ...
  // NPCs
  LancerNPCClassStatsData_to_INpcClassStatsData(
    t: LancerNPCClassStatsData
  ): INpcClassStats {
    return {
      ...t,
      evade: t.evasion,
  ...
  LancerNPCFeatureData_to_INpcFeatureData(
    t: LancerNPCFeatureData
  ): INpcFeatureData {
    return {
      brew: this.brew,
      hide_active: false,
  ...
  LancerNPCTemplateData_to_INpcTemplateData(
    t: LancerNPCTemplateData
  ): INpcTemplateData {
    return {
      brew: this.brew,
  ...
  // Pilot equipment
  LancerPilotGearData_to_IPilotEquipment(
    t: LancerPilotGearData
  ): IPilotGearData {
    return {
      brew: this.brew,
      counters: [],
  ...
  LancerPilotWeaponData_to_IPilotEquipment(
    t: LancerPilotWeaponData
  ): IPilotWeaponData {
    return {
      brew: this.brew,
      counters: [],
  ...
  LancerPilotArmorData_to_IPilotEquipment(
    t: LancerPilotArmorData
  ): IPilotArmorData {
    return {
      brew: this.brew,
      counters: [],
  ...
  // SYSTEMS
  LancerMechSystemData_to_IMechSystemData(
    t: LancerMechSystemData
  ): IMechSystemData {
    return {
      ...t,
      brew: this.brew,
  ...
  // WEAPONS
  LancerMechWeaponData_to_IMechWeaponData(
    t: LancerMechWeaponData
  ): IMechWeaponData {
    return {
      ...t,
      brew: this.brew,
  ...
  LancerMechSystemData_to_IEquipmentData(
    s: LancerMechSystemData
  ): IEquipmentData {
    return {
...
LancerPilotSheetData_to_IPilotData(t: LancerPilotSheetData): IPilotData {
  ...
  let talents = t.talents.map((x) =>
    this.LancerTalentData_to_IRankedData(x.data.data)
  );
  let core_bonuses = t.core_bonuses.map(
    (x) => this.LancerCoreBonusData_to_CompID(x.data.data).id
  );
  let skills = t.skills.map((x) =>
    this.LancerSkillData_to_IRankedData(x.data.data)
  );
  let mech_id = uid();
  let mechs = [
    this.convert_mech(t.data.mech, t.frame.data.data, t.data.mech_loadout, mech_id),
  ];
