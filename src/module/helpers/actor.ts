...
export function stat_edit_card(title: string, data_path: string, helper: HelperData): string {
  ...
  return `
    <div class="card clipped">
      ...
      ${std_num_input(
        data_path,
        ext_helper_hash(helper, { classes: "lancer-stat lancer-invisible-input major" })
      )}
    </div>
    `;
}
...
export function clicker_num_input(data_path: string, helper: HelperData) {
  return `<div class="flexrow arrow-input-container">
      ...
      ${std_num_input(
        data_path,
        ext_helper_hash(helper, { classes: "lancer-stat minor", default: 0 })
      )}
...
export function struct_macro_button(robo_path: string, helper: HelperData): string {
  ...
  return `<a class="lancer-macro i--sm cci cci-condition-stunned" style="max-width: min-content;"  ${macro_elt_params(
    macro_ctx
  )}> </a>`;
}
...
export function stress_macro_button(robo_path: string, helper: HelperData): string {
  ...
  return `<a class="lancer-macro i--sm cci cci-status-exposed" style="max-width: min-content;"  ${macro_elt_params(
    macro_ctx
  )}> </a>`;
}
