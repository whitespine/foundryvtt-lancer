 ...
 */
export function single_owned_deployable_preview(
  item_path: string,
  deployable_path: string,
  helper: HelperData
): string {
  // Resolve the item
 ...
 */
export function deployable_list_display(
  item_path: string,
  deployables_path: string,
  helper: HelperData
): string {
  let items: string[] = [];
